...
export default function App() {
  ...
  return (
    <SafeAreaProvider style={{ backgroundColor: "#EEEEEEff" }}>
      {/* Menggunakan edges top dan bottom untuk menangani area navigasi sistem secara otomatis */}
      <SafeAreaView style={{ flex: 1, backgroundColor: "#EEEEEEff" }} edges={['top', 'bottom']}>
